...
const auto testBucketizeParams3700 = ::testing::Combine(
        ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(inputShapes)),  // data shape, bucket shape
        ::testing::ValuesIn(with_right_bound),                                             // Right edge of interval
        ::testing::ValuesIn(dataInputPrecisions),                                          // Data input precision
        ::testing::ValuesIn(bucketsInputPrecisions),                                       // Buckets input precision
        ::testing::Values(outputPrecisions[0]),                                            // Output precision

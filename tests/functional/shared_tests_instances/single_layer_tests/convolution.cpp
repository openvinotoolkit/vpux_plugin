...
INSTANTIATE_TEST_CASE_P(smoke_Convolution1D, ConvolutionLayerTest_NPU4000_SW, conv1D,
                        ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_AutoPadValid, ConvolutionLayerTest_NPU4000_SW, conv2D_AutoPadValid,
                        ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_CMajorCompatible, ConvolutionLayerTest_NPU4000_SW, conv2D_CMajorCompatible,
                        ConvolutionLayerTest::getTestCaseName);
...
// NPU4000
INSTANTIATE_TEST_CASE_P(smoke_Convolution3D_3x2x2_Kernel, ConvolutionLayerTest_NPU4000_HW,
                        ::testing::Combine(conv3DParams_3x2x2_Kernel,            //
                                           ::testing::Values(ov::element::f16),  // netPrc
                                           ::testing::ValuesIn({static_shapes_to_test_representation({ov::Shape{
                                                   1, 32, 5, 28, 28}})}),   // inputShapes
...
// NPU4000
INSTANTIATE_TEST_CASE_P(smoke_Convolution3D_3x1x1_Kernel, ConvolutionLayerTest_NPU4000_HW,
                        ::testing::Combine(conv3DParams_3x1x1_Kernel,            //
                                           ::testing::Values(ov::element::f16),  // netPrc
                                           ::testing::ValuesIn({static_shapes_to_test_representation({ov::Shape{
                                                   1, 32, 6, 28, 28}})}),   // inputShapes
...
INSTANTIATE_TEST_CASE_P(smoke_precommit_Convolution2D_AsymmetricPadding, ConvolutionLayerTest_NPU4000_SW,
                        conv2D_AsymmetricPadding, ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_AsymmetricKernel, ConvolutionLayerTest_NPU4000_SW, conv2D_AsymmetricKernel,
                        ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_Dilated, ConvolutionLayerTest_NPU4000_SW, conv2D_Dilated,
                        ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution2D_LargeSize3, ConvolutionLayerTest_FP32_SW,
...
INSTANTIATE_TEST_CASE_P(smoke_Convolution3D, ConvolutionLayerTest_NPU4000_HW,
                        ::testing::Combine(conv3DParams,                         //
                                           ::testing::Values(ov::element::f16),  // netPrc
                                           ::testing::ValuesIn({static_shapes_to_test_representation({ov::Shape{
                                                   1, 3, 64, 64, 64}})}),  // inputShapes

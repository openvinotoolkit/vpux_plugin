...
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL11]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32>
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL11]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32>
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL11]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32>
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL11]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32>
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL11]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32_MULTICAST_BASE>
...
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL12]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32_RTM>
//CHECK-DAG: ELFNPU37XX.Reloc baseOp(%[[VAL12]] : !VPURegMapped.Index<0:0:0>) {{.*}} <R_VPU_32_SUM>

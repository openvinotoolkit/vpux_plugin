...
IE.TileResource 1 of @NCE at 6.000000e+02 MHz
  ...
  func.func private @nndma_2d_to_3d_with_single_shape() {
    ...
    // CHECK:   descriptor(<numPlanes = 3 : i32, len = 464 : i32, srcWidth = 464 : i32, srcStride = 464 : i32, srcPlaneStride = 103936 : i32, dstWidth = 464 : i32, dstStride = 480 : i32, dstPlaneStride = 111360 : i32>)
...
IE.TileResource 1 of @NCE at 6.000000e+02 MHz
  ...
  func.func private @nndma_3d_to_2d_with_single_shape() {
    ...
    // CHECK:   descriptor(<numPlanes = 3 : i32, len = 464 : i32, srcWidth = 464 : i32, srcStride = 480 : i32, srcPlaneStride = 111360 : i32, dstWidth = 464 : i32, dstStride = 464 : i32, dstPlaneStride = 103936 : i32>)
...
IE.TileResource 1 of @NCE at 6.000000e+02 MHz
  ...
  func.func private @nndma_2d_to_3d_input_stride_on_the_highest_dim() {
    ...
    // CHECK:   descriptor(<numPlanes = 23 : i32, len = 10240 : i32, srcWidth = 10240 : i32, srcStride = 10240 : i32, srcPlaneStride = 10240 : i32, dstWidth = 512 : i32, dstStride = 1024 : i32, dstPlaneStride = 61440 : i32>)
...
IE.TileResource 1 of @NCE at 6.000000e+02 MHz
  ...
  func.func private @nndma_3d_to_2d_output_stride_on_the_highest_dim() {
    ...
    // CHECK:   descriptor(<numPlanes = 23 : i32, len = 10240 : i32, srcWidth = 512 : i32, srcStride = 1024 : i32, srcPlaneStride = 61440 : i32, dstWidth = 10240 : i32, dstStride = 10240 : i32, dstPlaneStride = 10240 : i32>)

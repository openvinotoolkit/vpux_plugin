...
// RUN: vpux-opt --split-input-file --vpu-arch=%arch% --unroll-fetch-ops %s | FileCheck %s
...
//CHECK: VPURegMapped.ViewTaskRange([[VAL19]] -> [[VAL20]] : <0:0:0> -> <0:0:1>) -> memref<2x352xui8>
//CHECK: VPURegMapped.ViewTaskRange([[VAL15]] -> [[VAL16]] : <0:0:0> -> <0:0:1>) -> memref<2x352xui8, [@CMX_NN, 0]>

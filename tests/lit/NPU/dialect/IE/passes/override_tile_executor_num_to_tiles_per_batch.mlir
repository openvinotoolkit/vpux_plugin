...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=%arch% allow-custom-values=true" --override-tile-executor-num="mode=override-to-tiles-per-batch" %s | FileCheck %s

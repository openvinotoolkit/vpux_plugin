...
func.func @RemoveFQU16(%arg0: tensor<1x3x640x640xf16>) -> tensor<1x4x640x640xf16> {
    ...
    // CHECK-SAME{LITERAL}:   dense<[[[[0.539961219]], [[-1.85364282]], [[1.99483931]], [[-2.17146444]]]]> : tensor<1x4x1x1xf32>, [#const.ConvertElemType<f16>]
...
// CHECK-LABEL: @RepaceFQU16WithReLU
func.func @RepaceFQU16WithReLU(%arg0: tensor<1x4x640x640xf16>) -> tensor<1x4x640x640xf16> {
    %cst = const.Declare tensor<1x1x1x1xf16> = dense<0.000000e+00> : tensor<1x1x1x1xf32>, [#const.ConvertElemType<f16>]
    %cst_0 = const.Declare tensor<1x1x1x1xf16> = dense<57.1374702> : tensor<1x1x1x1xf32>, [#const.ConvertElemType<f16>]

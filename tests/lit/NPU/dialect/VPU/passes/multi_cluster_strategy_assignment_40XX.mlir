...
func.func @TwoConvsAssignedSOHOverlapped(%arg0: tensor<1x256x12x4xf16, {order = #NHWC}>) -> tensor<1x64x6x2xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %weight_0, %weight_table_0) {pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [32, 256, 1, 1], strides = [2, 2]} -> tensor<1x32x6x2xf16, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %weight_1, %weight_table_1) {pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [64, 32, 3, 3], strides = [1, 1]} -> tensor<1x64x6x2xf16, {order = #NHWC}>
    ...
    //CHECK:        [[CONV_0:%.*]] = VPU.NCE.Convolution(%arg0, [[WEIGHTS_0]], [[WEIGHTSTABLE_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [32, 256, 1, 1], strides = [2, 2]} -> tensor<1x32x6x2xf16, {order = #NHWC}>
    ...
    //CHECK:        [[CONV_1:%.*]] = VPU.NCE.Convolution([[CONV_0]], [[WEIGHTS_1]], [[WEIGHTSTABLE_1]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [64, 32, 3, 3], strides = [1, 1]} -> tensor<1x64x6x2xf16, {order = #NHWC}>
...
func.func @ConvAssignedSOB3Batches(%arg0: tensor<3x1024x14x14xf16, {order = #NHWC}>) -> tensor<3x256x14x14xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [256, 1024, 1, 1], strides = [1, 1]} -> tensor<3x256x14x14xf16, {order = #NHWC}>
    ...
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [256, 1024, 1, 1], strides = [1, 1]}
...
func.func @ConvAssignedSOB(%arg0: tensor<6x1024x14x14xf16, {order = #NHWC}>) -> tensor<6x256x14x14xf16, {order = #NHWC}> {
    %cst = const.Declare tensor<256x1x1x4xsi32> = dense<10> : tensor<256x1x1x4xsi32>
    %cst_0 = const.Declare tensor<256x1024x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<256x1024x1x1xf16>, [#const.Reorder<#NHWC>]
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [256, 1024, 1, 1], strides = [1, 1]} -> tensor<6x256x14x14xf16, {order = #NHWC}>
...
func.func @ConvAssignedClustering(%arg0: tensor<1x64x1x1xf16, {order = #NHWC}>) -> tensor<1x48x1x1xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.*]] = VPU.NCE.Convolution(%arg0, [[WEIGHTS]], [[WEIGHTSTABLE]])
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [48, 64, 3, 3], strides = [1, 1]}
...
func.func @DepthConvAssignedSOHOverlapped(%arg0: tensor<1x32x112x112xf16, {order = #NHWC}>) -> tensor<1x32x112x112xf16, {order = #NHWC}> {
    ...
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [32, 1, 3, 3], strides = [1, 1]}
...
func.func @DepthConvAssignedClustering(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x1x1xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.*]] = VPU.NCE.DepthConvolution(%arg0, [[WEIGHTS]], [[WEIGHTSTABLE]])
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [32, 1, 3, 3], strides = [1, 1]}
...
func.func @Mvn6AssignedSplitOverKernel(%arg0: tensor<1x32x15x64xf16>) -> tensor<1x32x15x64xf16> {
    %0 = VPU.MVN6(%arg0) {axes = [2], eps = 9.9999997473787516E-6 : f64, eps_mode = #IE.mvn_eps_mode<INSIDE_SQRT>, normalize_variance = true} : tensor<1x32x15x64xf16> -> tensor<1x32x15x64xf16>
...
func.func @Mvn6AssignedSplitOverHeight(%arg0: tensor<1x32x15x64xf16>) -> tensor<1x32x15x64xf16> {
    %0 = VPU.MVN6(%arg0) {axes = [1, 3], eps = 9.9999997473787516E-6 : f64, eps_mode = #IE.mvn_eps_mode<INSIDE_SQRT>, normalize_variance = true} : tensor<1x32x15x64xf16> -> tensor<1x32x15x64xf16>
    return %0 : tensor<1x32x15x64xf16>
...
func.func @Mvn6AssignedClustering(%arg0: tensor<1x32x15x1xf16>) -> tensor<1x32x15x1xf16> {
    %0 = VPU.MVN6(%arg0) {axes = [1, 2], eps = 9.9999997473787516E-6 : f64, eps_mode = #IE.mvn_eps_mode<INSIDE_SQRT>, normalize_variance = true} : tensor<1x32x15x1xf16> -> tensor<1x32x15x1xf16>
...
func.func @ConvBeforeMVNAssignedSplitOverKernel(%arg0: tensor<1x128x64x128x!qElemType3, {order = #NHWC}>) -> tensor<1x64x64x128xf16> {
    ...
    %cst_0 = const.Declare tensor<64x128x4x4x!qElemType, {order = #NHWC}> = dense<10.1> : tensor<64x128x4x4xf32>, [#const.ConvertElemType<f16>, #const.ConvertElemType<si8>, #const.QuantCast<!qElemType1>, #const.QuantCast<>, #const.ConvertElemType<i32>, #const.Add<1.270000e+02 : f64>, #const.ConvertElemType<ui8>, #const.QuantCast<!qElemType>, #const.Reorder<#NHWC>]
    %4 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = #VPU.Padding<left = 2 : i64, right = 1 : i64, top = 2 : i64, bottom = 1 : i64>, ppe = #VPU.PPETask<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>, rawFilterShape = [64, 128, 4, 4], strides = [1, 1]} -> tensor<1x64x64x128xf16>
...
func.func @InterpolateBilinearAssignedSOH(%arg0: tensor<1x96x20x20xf16, {order = #NHWC}>) -> tensor<1x96x40x40xf16, {order = #NHWC}> {
    ...
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
    // CHECK-SAME:      ppe = #VPU.PPETask<mode = <NOOP>, clamp_low = 0 : i64, clamp_high = 2147483967 : i64,  lrelu_mult = 1 : i64, lrelu_shift = 0 : i64>
...
func.func @Test_UniformDistributedSegments_for_NCEOp(%arg0: tensor<1x64x608x608xf16, {order = #NHWC}>) -> tensor<1x256x608x608xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) {pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [256, 64, 3, 3], strides = [1, 1]} -> tensor<1x256x608x608xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution(%arg0, %cst_0, %cst)
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [256, 64, 3, 3], strides = [1, 1]}
...
func.func @Test_UniformDistributedSegments_for_ClusterOp_NceOp(%arg0: tensor<1x128x10x10xf16, {order = #NHWC}>) -> tensor<1x128x20x20xf16, {order = #NHWC}> {
    ...
    // CHECK-SAME   multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, ppe = #VPU.PPETask<mode = <NOOP>, clamp_low = 0 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64>, rawFilterShape = [128, 128, 1, 1], scales_attr = [2, 2], strides = [1, 1]} -> tensor<1x128x20x20xf16, {order = #NHWC}>
    // CHECK:       return [[OUTPUT]] : tensor<1x128x20x20xf16, {order = #NHWC}>
}
...
func.func @PropagateDistributedQuantizeCast(%arg0: tensor<1x512x14x14x!qElemType, {order = #NHWC}>) -> tensor<1x512x14x14x!qElemType1, {order = #NHWC}>{
    %eltwise = VPU.NCE.Eltwise(%arg0, %arg0) { op_type = #VPU.eltwise_type<ADD> } :
...
func.func @PropagateDistributedPermuteCast(%arg0: tensor<1x4096x1024x4xf16, {order = #NHWC}>, %arg1: tensor<48x4096x1x1xf16, {order = #NHWC}>) -> tensor<1x320x1024x4x!qElemType, {order = #NHWC}> {
    ...
    %dw_conv_weights = const.Declare tensor<320x16x1x1xf16, {order = #NHWC}> = dense<1.0> : tensor<1x1x320xf32>, [#const.ConvertElemType<f16>, #const.Reshape<[1, 320, 1, 1]>, #const.Reshape<[320, 1, 1, 1]>, #const.PadWithZero<[0, 0, 0, 0], [0, 15, 0, 0]>, #const.Reorder<#NHWC>]
    ...
    %11 = VPU.NCE.DepthConvolution(%10, %dw_conv_weights, %dw_conv_weights_table) {
        ...
        lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 453.72720336914063 : f64>,
...
func.func @ConvAssignedSOHWithSOHIncompatibleConsumer(%arg0: tensor<1x256x2000x1xf16, {order = #NHWC}>) -> tensor<1x256x2000x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %weights_0, %weights_table_0) {pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, rawFilterShape = [256, 256, 3, 3], strides = [1, 1]} -> tensor<1x256x2000x1xf16, {order = #NHWC}>
    ...
    %1 = VPU.NCE.Convolution(%0, %weights_1, %weights_table_1) {pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, rawFilterShape = [64, 256, 1, 1], strides = [8, 1]} -> tensor<1x64x250x1xf16, {order = #NHWC}>

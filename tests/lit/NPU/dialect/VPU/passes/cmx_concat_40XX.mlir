...
func.func @SOWProducersSOWConsumersOfConcatWithExplicitDistributedAttrWithHSlice(
    ...
    %conv0Output = VPU.NCE.ClusterTiling (
        ...
        %0 = VPU.NCE.Convolution(%arg2, %arg3, %arg4) {
            opaque_ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64>,
...
func.func @InsertAvgPoolingWhenNCEOpHasExtraUser(%arg0: tensor<1x64x36x36xf16, {order = #NHWC}>)
    ...
    %3 = VPU.NCE.ClusterTiling (
        ...
        %21 = VPU.NCE.Convolution(%arg1, %arg2, %arg3) {
                opaque_ppe = #VPU.PPEInt<mode = <LRELU>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
    ...
    %7 = VPU.NCE.ClusterTiling (
        ...
        %21 = VPU.NCE.DepthConvolution(%arg1, %arg2, %arg3) {
                opaque_ppe = #VPU.PPEInt<mode = <LRELU>, clamp_low = -128 : i64, clamp_high = 127 : i64,
                lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
    ...
    // CHECK-SAME:                  opaque_ppe = #VPU.PPEInt<mode = <LRELU>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
    ...
    // CHECK-SAME:                          opaque_ppe = #VPU.PPEInt<mode = <LRELU>, clamp_low = -128 : i64, clamp_high = 127 : i64,
    // CHECK-SAME:                              lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,

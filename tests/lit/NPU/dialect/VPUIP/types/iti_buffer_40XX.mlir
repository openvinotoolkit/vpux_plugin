...
// CHECK:   return
// CHECK-SAME:    !VPUIP.ITIBuffer<1x48x50x170xf16, {order = #NHWC}, [@CMX_NN, 0],
// CHECK-SAME:    inwardHaloRegions = [#VPUIP.HaloRegionAttr<shape = [1, 48, 2, 170], offset = [0, 0, 48, 0], cluster_id = 0 : i64>]>
// CHECK-SAME:    !VPUIP.ITIBuffer<1x48x47x170xf16, {order = #NHWC}, [@CMX_NN, 1],
// CHECK-SAME:    outwardHaloRegions = [#VPUIP.OutwardHaloRegionAttr<shape = [1, 48, 2, 170], offset = [0, 0, 0, 0], cluster_id = 1 : i64,
// CHECK-SAME:    inwardHaloRegions = [#VPUIP.HaloRegionAttr<shape = [1, 48, 2, 170], offset = [0, 0, 48, 0], cluster_id = 0 : i64>]>]>

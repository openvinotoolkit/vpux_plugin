...
// RUN: vpux-opt --vpu-arch=%arch% --legalize-schedule-for-wlm %s | FileCheck %s
...
module @dumpsubgraph attributes {VPU.arch = #VPU.arch_kind<NPU40XX>, VPU.compilationMode = #VPU.compilation_mode<DefaultHW>} {
  ...
  func.func @main(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x56x56xf16, @DDR>) -> memref<1x64x56x56xf16, @DDR> {
    ...
    VPURT.Task updates(%bar0: !VPURT.Barrier) {
      %58 = VPUIP.NNDMA {port = 0 : i64} inputs(%8 : memref<1x3x115x224xf16, {order = #NCHW, strides = [150528, 50176, 224, 1]}, @DDR>) outputs(%12 : memref<1x3x115x224xf16, [@CMX_NN, 1]>) -> memref<1x3x115x224xf16, [@CMX_NN, 1]>
    }
  ...
  // CHECK:  VPUIP.NNDMA {port = 0 : i64} inputs([[BUF0]] : memref<0x0x0x0xi32, @DDR>) outputs([[BUF1]] : memref<0x0x0x0xi32, @DDR>)

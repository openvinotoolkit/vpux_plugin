...
vpux::ELF::SectionFlagsAttr vpux::VPUASM::ActShaveRtOp::getAccessingProcs(mlir::SymbolUserMap&) {
    return (ELF::SectionFlagsAttr::VPU_SHF_PROC_SHAVE);
}

vpux::ELF::SectionFlagsAttr vpux::VPUASM::ActShaveRtOp::getUserProcs() {

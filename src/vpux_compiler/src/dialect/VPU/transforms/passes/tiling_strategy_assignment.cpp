...
public:
    explicit TilingStrategyAssignmentPass(bool enablePrefetchTiling, bool vpunnCost,
...
std::unique_ptr<mlir::Pass> vpux::VPU::createTilingStrategyAssignmentPass(bool enablePrefetchTiling, bool vpunnCost,
                                                                          ...
                                                                          Logger log) {
    return std::make_unique<TilingStrategyAssignmentPass>(enablePrefetchTiling, vpunnCost,

...
void updateNceOps(NCEClusterTaskOp nceOp, DenseMap<NCEClusterTaskOp, NceOpOutputs>& newOutputs, Logger log) {
    ...
    auto updatedNceOp = VPURT::wrapIntoTaskOp<NCEClusterTaskOp>(
            ...
            /*instruction_list_table*/ nullptr, /*str_lookup_table=*/nullptr, nceOp.getActivationWindow(),
            ...
            nceOp.getActivationWindowChannelLengthAttr(), nceOp.getIsContinuedAttr(), nceOp.getCmSpPatternAttr(),
